 ...
 * <p>数据流程：UserProfileService.userProfile(uid).topCategories(2) → 遍历可见帖按类目匹配取画像权重
...
public class CategoryRecall implements RecallChannel {
    ...
    public CategoryRecall(UserProfileService userProfileService, PostRepository postRepository) {
