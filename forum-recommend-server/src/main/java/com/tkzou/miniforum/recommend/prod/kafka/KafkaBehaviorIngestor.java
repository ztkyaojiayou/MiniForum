...
@Component
@Profile("prod")
public class KafkaBehaviorIngestor {

    private static final Logger log = LoggerFactory.getLogger(KafkaBehaviorIngestor.class);
    ...
    public KafkaBehaviorIngestor(BehaviorLogRepository behaviorLogRepository,
