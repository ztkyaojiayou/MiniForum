 ...
 *     ├③ rank.RuleFineRankService.rank → 微博式 rankScore → List&lt;RankedItem&gt;（带特征分构成 + 推荐理由）
 ...
 * <b>架构要点</b>：
 * <ul>
 *   <li>排序/召回<b>接口与实现分离</b>（RecallService/RecallChannel、RankService/RuleFineRankService、
